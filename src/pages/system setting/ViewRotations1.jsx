...
console.log("viewRotation" , props.data)
    ...
    let start = new Date(props.data.startDate).toLocaleString().split(',')[0];
    let end = new Date(props.data.endDate).toLocaleString().split(',')[0];
...
// functions and events
    ...
    return (
        <>
        <label> Session Period : {mergedDate}</label> 
          <label> Create Rotation</label> 
            <Form
                name="basic"
                labelCol={{ span: 8 }}
                wrapperCol={{ span: 16 }}
